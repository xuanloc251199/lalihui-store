...
{{-- @section('layout._header.blader.php') --}}
@section('content')
    <!-- Hero section start -->
    <!-- Hero section start -->
    <section class="hero">
        <div class="container d-xl-flex align-items-start">
            <div class="hero_about col-xl-6">
                <div class="hero_header">
                    <h1 class="hero_header-title">{{ $slides->first()->title }}</h1>
                    <p class="hero_header-text">{{ $slides->first()->sub_title }}</p>
            ...
            <div class="hero_promo col-xl-6">
                ...
                <div class="hero_slider swiper">
                    <div class="swiper-wrapper">
                        @foreach ($slidesByProducts as $slidesByProduct)
                            <div class="hero_slider-slide swiper-slide">
                                <div class="hero_slider-slide_media">
                                    <img class="lazy"
                                        src="{{ asset('img/products/un-background/' . $slidesByProduct->product->thumbnail) }}"
                                        alt="media">
                                </div>
                                <div class="hero_slider-slide_main">
                                    <h2 class="title">{{ $slidesByProduct->product->prd_name }}</h2>
                                    <p class="text">{{ $slidesByProduct->product->detail }}</p>
                            ...
                            <div class="media">
                                <a href="">
                                    <img class="lazy preview"
                                        src="{{ asset('img/products/un-background/' . $product->thumbnail) }}"
                                        alt="{{ $product->prd_name }}">
                                </a>
                            </div>
                            <div class="main d-flex flex-column align-items-center justify-content-between">
                                <a class="main_title" href="">{{ $product->prd_name }}</a>
    ...
    <div class="product section">
        <div class="container d-flex flex-column flex-lg-row">
            ...
            <div class="product_main col-lg-6">
                <a class="product_main-title" href="product.php" target="_blank" rel="noopener norefferer">CBD Facial
                    Serum: Anti-Aging + Daily Moisturizer</a>
                ...
                <p class="product_main-text">
                    Quis risus sed vulputate odio ut. Arcu vitae elementum curabitur vitae nunc sed. Mauris a diam maecenas
                    sed enim
    ...
    <section class="info section">
        <div class="info_deco">
            <div class="info_deco-wrapper">
                <picture>
                    <source data-srcset="./img/placeholder.jpg" srcset="./img/placeholder.jpg" type="image/webp" />
                    <img class="lazy leaf leaf--left" data-src="./img/placeholder.jpg" src="./img/placeholder.jpg"
                        alt="deco" />
                </picture>
            </div>
            <div class="info_deco-wrapper">
                <picture>
                    <source data-srcset="./img/placeholder.jpg" srcset="./img/placeholder.jpg" type="image/webp" />
                    <img class="lazy leaf leaf--right" data-src="./img/placeholder.jpg" src="./img/placeholder.jpg"
                        alt="deco" />
                </picture>
            </div>
        </div>
            ...
            <div class="effects_header d-lg-flex flex-xxl-column col-md-12 col-xxl-auto">
                <div class="main col-lg-6 col-xl-12">
                    ...
                    <p class="effects_header-text">
                        Accumsan sit amet nulla facilisi morbi tempus. Suscipit tellus mauris a diam maecenas sed enim ut
                        sem.
                ...
                <span class="effects_header-formula col-lg-6 col-xl-12">
                    <svg width="281" height="157" viewBox="0 0 281 157" fill="none"
            ...
            <div class="latest_wrapper d-flex flex-column-reverse flex-lg-row">
                <div class="latest_promo" data-aos="fade-right">
                    <picture>
                        ...
                        <img class="lazy latest_promo-bg" data-src="./img/placeholder.jpg" src="./img/placeholder.jpg"
                            alt="promo" />
                    </picture>
                ...
                <ul class="latest_list col-lg-7 col-xl-6">
                    <li class="list-item d-flex flex-column flex-sm-row" data-aos="fade-up">
                        <span class="latest_list-preview">
                            <picture>
                                <source data-srcset="./img/placeholder.jpg" srcset="./img/placeholder.jpg"
                                    type="image/webp" />
                                <img class="lazy preview-img" data-src="./img/placeholder.jpg"
                                    src="./img/placeholder.jpg" alt="Top 15 Best Strain Of Weed For Anxiety" />
                            </picture>
                        </span>
                        <div class="latest_list-main d-sm-flex flex-column justify-content-between flex-grow-1">
                            ...
                            <p class="text">
                                Felis eget velit aliquet sagittis id consectetur. Eleifend donec pretium vulputate sapien
                                nec
                                sagittis
                            </p>
                        </div>
                        ...
                        <span class="latest_list-preview">
                            <picture>
                                <source data-srcset="./img/placeholder.jpg" srcset="./img/placeholder.jpg"
                                    type="image/webp" />
                                <img class="lazy preview-img" data-src="./img/placeholder.jpg"
                                    src="./img/placeholder.jpg" alt="Raw Cannabis Seeds Promote Health" />
                            </picture>
                        </span>
                        <div class="latest_list-main d-sm-flex flex-column justify-content-between flex-grow-1">
                            <span class="metadata">
                        ...
                        <span class="latest_list-preview">
                            <picture>
                                <source data-srcset="./img/placeholder.jpg" srcset="./img/placeholder.jpg"
                                    type="image/webp" />
                                <img class="lazy preview-img" data-src="./img/placeholder.jpg"
                                    src="./img/placeholder.jpg" alt="How Many Autoflowers In a Tent?" />
                            </picture>
                        </span>
                        <div class="latest_list-main d-sm-flex flex-column justify-content-between flex-grow-1">
                            <span class="metadata">
